...
const Vente = () => {
    ...
    useEffect(() => {
        console.log("vente en useEffect:", vente);
        if (vente?.onEdit) {
            setPostData({
                ...
                attributes: {
                    superficie: vente.attributes?.superficie || "",
                    etage: vente.attributes?.etage || "",
                    piece: vente.attributes?.piece || "",
                    promoteurimmobilier: vente.attributes?.promoteurimmobilier || "",
                    parlepromoteurimmobilier: vente.attributes?.parlepromoteurimmobilier || "",
                    conditiondepeyement: vente.attributes?.conditiondepeyement || "",
                    specifications: vente.attributes?.specifications || "",
                    papiers: vente.attributes?.papiers || "",
                },
            });
