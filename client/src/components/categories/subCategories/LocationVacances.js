...
const LocationVacances = () => {
    const { auth, theme, socket, statusImmobilierReducer } = useSelector((state) => state);
    const { locationvacances } = statusImmobilierReducer
    const dispatch = useDispatch();

    // Un estado combinado para subCategoryLocationVacances y vente
    const [postData, setPostData] = useState({
        subCategoryLocationVacances: "",          // Categoría principal (vente, location, echange)
        tiempodealquiler: "",
        superficie: "",
        piece: "",
    ...
    const handleSubmit = e => {
        ...
        if (images.length === 0)
            return dispatch({
                ...
                payload: { error: 'Veuillez ajouter les images .' },
            });

        if (locationvacances.onEdit) {
            dispatch(updatePost({ postData, images, auth, locationvacances }));
        } else {
        ...
        dispatch({ type: GLOBALTYPES.LOCATIONVACANCES, payload: false });
    };
    ...
    useEffect(() => {
        if (locationvacances.onEdit) {
            ...
            setPostData({
                subCategoryLocationVacances: locationvacances.subCategoryLocationVacances || "",
                tiempodealquiler: locationvacances.tiempodealquiler || "",
                superficie: locationvacances.superficie || "",
                piece: locationvacances.piece || "",
                etage: locationvacances.etage || "",
                change: locationvacances.change || "",
                oferta: locationvacances.oferta || "",

                promoteurimmobilier: locationvacances.promoteurimmobilier || "",
                parlepromoteurimmobilier: locationvacances.parlepromoteurimmobilier || "",

                duraciondelanuncio: locationvacances.duraciondelanuncio || "",
                conditiondepeyement: locationvacances.conditiondepeyement || "",
                specifications: locationvacances.specifications || "",

                description: locationvacances.description || "",
                price: locationvacances.price || "",
                unidaddeprecio: locationvacances.unidaddeprecio || "",
                oferta: locationvacances.oferta || "",
                change: locationvacances.change || "",
                commune: locationvacances.commune || "",
                wilaya: locationvacances.wilaya || "",
                quartier: locationvacances.quartier || "",
                email: locationvacances.email || "",
                telefono: locationvacances.telefono || "",
                contadordevisitas: locationvacances.contadordevisitas || "",
                informacion: locationvacances.informacion || "",
                comentarios: locationvacances.comentarios || "",

                papiers: locationvacances.papiers || "",
            });
            setImages(locationvacances.images || []); // Asegurar imágenes
        }
    }, [locationvacances]);
        ...
        <div className='status_modal' >
            <form onSubmit={handleSubmit}>
                <div className="status_header">
                    <h5 className="m-0">Annonces Location Vacances</h5>
                    <span onClick={() => dispatch({
                        type: GLOBALTYPES.LOCATIONVACANCES, payload: false
                    })}>
                        &times;
                    </span>
                </div>
                ...
                <div className="status_body">
                    <div className="form-group">
                        ...
                        <select
                            ...
                            value={postData.subCategoryLocationVacances}
                            name="subCategoryLocationVacances"
                    ...
                    {postData.subCategoryLocationVacances === "Appartement" && (
                    ...
                    {postData.subCategoryLocationVacances === "Studio" && (
                        <div>
                            <div className='form-group'>
                                <div className="form-group">
                                    <label className='text-primary'> Transaction</label>
                    ...
                    {postData.subCategoryLocationVacances === "Villa" && (
                        <div className='form-group'>
                    ...
                    {postData.subCategoryLocationVacances === "Niveau de villa" && (
                        <div className='form-group'>
                            <div className="form-group">
                                <label className='text-primary'> Transaction</label>
                                <select
                    ...
                    {postData.subCategoryLocationVacances === "Duplex" && (
                        <div className='form-group'>
                    ...
                    {postData.subCategoryLocationVacances === "Bungalow" && (
                        <div className='form-group'>
                            <div className="form-group">
                                <label className='text-primary'> Transaction</label>
                                <select
                    ...
                    {postData.subCategoryLocationVacances === "Autre" && (
                        <div className='form-group'>
                    ...
                    <div className="form-group">
                        ...
                        <input onChange={handleChangeInput} value={postData.email} name="email" type="email" className="form-control" placeholder='Adresse mail ' required />
