...
const Echange = () => {
    ...
    const { echange} = statusImmobilierReducer
    ...
    const handleSubmit = e => {
        ...
        if (echange.onEdit) {
            dispatch(updatePost({ postData, images, auth, echange }));
        } else {
        ...
        dispatch({ type: GLOBALTYPES.echange, payload: false });
    };
    ...
    useEffect(() => {
        if (echange.onEdit) {
            ...
            setPostData({
                subCategory: echange.subCategory || "",
                superficie: echange.superficie || "",
                piece: echange.piece || "",
                etage: echange.etage || "",
                change: echange.change || "",
                oferta: echange.oferta || "",

                promoteurimmobilier: echange.promoteurimmobilier || "",
                parlepromoteurimmobilier: echange.parlepromoteurimmobilier || "",

                duraciondelanuncio: echange.duraciondelanuncio || "",
                conditiondepeyement: echange.conditiondepeyement || "",
                specifications: echange.specifications || "",

                description: echange.description || "",
                price: echange.price || "",
                unidaddeprecio: echange.unidaddeprecio || "",
                oferta: echange.oferta || "",
                change: echange.change || "",
                commune: echange.commune || "",
                wilaya: echange.wilaya || "",
                quartier: echange.quartier || "",
                email: echange.email || "",
                telefono: echange.telefono || "",
                contadordevisitas: echange.contadordevisitas || "",
                informacion: echange.informacion || "",
                comentarios: echange.comentarios || "",

                papiers: echange.papiers || "",
            });
            setImages(echange.images || []); // Asegurar imágenes
        ...
        <div className='status_modal' >
            <form onSubmit={handleSubmit}>
                <div className="status_header">
                    <h5 className="m-0">Annonces Echange Immobilière</h5>
                    <span onClick={() => dispatch({
                        type: GLOBALTYPES.ECHANGE, payload: false
                    })}>
                        &times;
                    </span>
                </div>
